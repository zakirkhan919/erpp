            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li>
                            <a class="slide-item" href="{{ route('credit.transection') }}">Credit</a>
                        </li>

                        <li>
                            <a class="slide-item" href="{{ route('spend.transection') }}">Spent</a>
                        </li>

                        <li>
                            <a class="slide-item" href="{{ route('financial') }}">Financial report</a>
                        </li>
