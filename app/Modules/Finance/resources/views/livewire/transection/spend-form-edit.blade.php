            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group ">
                        <label for="exampleInputDescription" class="form-label">নগদ খরচ এর বিস্তারিত লিখুন<span class="text-danger">*</span></label>
                        <textarea type="text" class="form-control @error('description') is-invalid @enderror"
                            id="exampleInputDescription" placeholder="নগদ খরচ এর বিস্তারিত লিখুন" wire:model.lazy='description'></textarea>
                        @error('description')
