            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group ">
                        <label for="exampleInputDescription" class="form-label">Provide Credit Cost Information</label><span class="text-danger">*</span></label>
                        <textarea type="text" class="form-control @error('description') is-invalid @enderror"
                            id="exampleInputDescription" placeholder="Provide Credit Cost Information" wire:model.lazy='description'></textarea>
                        @error('description')
