...
@section('content')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">নগদ খরচ</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">হোম </a></li>
                            <li class="breadcrumb-item active" aria-current="page">নগদ খরচ </li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">নগদ খরচ এর তালিকা </h3>
 ...
 $checkAdmin = Auth::guard("web")->user()->type == "admin" || Auth::guard("web")->user()->type == "superadmin" ? true : false?>
                                <a href="{{ route('add.spend.transection') }}" class="f-right @if(array_search("amount/spend/add",$access) > -1 || $checkAdmin) @else d-none @endif">
                                    <button style="margin-bottom: 15px;"
                                        class="btn btn-primary bg-success-gradient mt-3">নতুন নগদ খরচ যোগ করুন</button>
                                </a>
                                <div class="table-responsive @if(array_search("amount/spend",$access) > -1 || $checkAdmin) @else d-none @endif">
...
<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
   <script>
       ...
       function deleteSpendAmount(id,e) {
           e.preventDefault();
           swal.fire({
