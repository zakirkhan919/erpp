        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Designation Edit</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Designation information edit</h3>
                            </div>
                            <form action="{{ route('update-designation')}}" method="post" id="seller-edit" name="seller-edit">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
