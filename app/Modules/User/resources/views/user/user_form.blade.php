        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="type" id="type" class="form-control">
                    ...
                    <option value="এডমিন" @if(optional($user)->type == "admin") selected @endif>Admin</option>
                    <option value="ম্যানেজার" @if(optional($user)->type == "manager") selected @endif>Manager</option>
                    <option value="অপারেটর" @if(optional($user)->type == "user") selected @endif>Operator</option>
                </select>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="role">Permission <span class='required-star'>*</span></label>
