        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Customer Edit</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Customer information edit</h3>
                            </div>
                            <form action="{{ route('update-customer')}}" method="post" id="customer-edit" name="customer-edit">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
