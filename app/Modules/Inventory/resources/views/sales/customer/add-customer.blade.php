                ...
                <div class="row row-sm">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form action="{{ route('submit-customer')}}" method="post" id="customer-add" name="customer-add">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="{{ old('email') }}" class="form-control @error('name') is-invalid @enderror" id="email" name="email"
                                                    placeholder="Email">
                                                @error('email')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('phone') }}" class="form-control @error('name') is-invalid @enderror" id="phone" name="phone"
                                                    placeholder="Phone">
                                                @error('phone')
                                                    <div class="text-danger mt-1 mb-1">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control @error('name') is-invalid @enderror" id="address" name="address" placeholder="Address">{{ old('address') }}</textarea>
                                                @error('address')
                                                    <div class="text-danger mt-1 mb-1">{{ $message }}</div>
                                                @enderror
                                            </div>
